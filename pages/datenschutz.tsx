    ...
    <>
      ...
      <Card style={{ margin: "2em", padding: "1em" }}>
        ...
        <p>
          ...
          Daten durch www.ahornapo.de und die Ihnen zustehenden Rechte.
        </p>
        ...
        <p>
          ...
          gespeichert: - IP-Adresse des anfragenden Rechners, - Datum und
          Uhrzeit des Zugriffs, - Name und URL der abgerufenen Datei, - Website,
          von der aus der Zugriff erfolgt (Referrer-URL), - verwendeter Browser
          und ggf. das Betriebssystem Ihres Rechners sowie der Name Ihres
          Access-Providers. Die genannten Daten werden durch uns zu folgenden
          Zwecken verarbeitet: - Gewährleistung eines reibungslosen
          Verbindungsaufbaus der Website, - Gewährleistung einer komfortablen
          Nutzung unserer Website, - Auswertung der Systemsicherheit und
          -stabilität sowie - zu weiteren administrativen Zwecken. Die
          Rechtsgrundlage für die Datenverarbeitung ist Art. 6 Abs. 1 S. 1 lit.
          f DSGVO. Unser berechtigtes Interesse folgt aus den oben aufgelisteten
        ...
        <p>
          ...
          <br />
          Für Fragen jeglicher Art bieten wir Ihnen die Möglichkeit, mit uns
        ...
        <p>
          ...
          Daten haben, - für den Fall, dass für die Weitergabe nach Art. 6 Abs.
        ...
        <p>
          ...
          Beschwerderechts sowie die Herkunft ihrer Daten, sofern diese nicht
          bei uns erhoben wurden, verlangen; - gemäß Art. 16 DSGVO unverzüglich
          die Berichtigung unrichtiger oder Vervollständigung Ihrer bei uns
          gespeicherten personenbezogenen Daten zu verlangen; - gemäß Art. 17
          DSGVO die Löschung Ihrer bei uns gespeicherten personenbezogenen Daten
          zu verlangen, soweit nicht die Verarbeitung zur Ausübung des Rechts
          ...
          Rechtsansprüchen erforderlich ist; - gemäß Art. 18 DSGVO die
          ...
          Verarbeitung eingelegt haben; - gemäß Art. 20 DSGVO Ihre
          ...
          Zukunft nicht mehr fortführen dürfen und - gemäß Art. 77 DSGVO sich
